...
mysql -uroot -Dmysql -e"update user set password=password(\"dir7413\") where user='root';"
echo "update user set password=password(\"dir7413\") where user='root';"
...
echo "INSERT INTO mysql.user (host,USER,password) VALUES ('%','root',password('dir7413'));"
